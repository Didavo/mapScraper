"""
Scraper für die Stadt Boxberg.
Website: https://www.boxberg.de
...
class BoxbergScraper(BaseScraper):
    """Scraper für Boxberg Veranstaltungen."""

    SOURCE_NAME = "Stadt Boxberg"
    BASE_URL = "https://www.boxberg.de"
    EVENTS_URL = "https://www.boxberg.de/freizeit-kultur/veranstaltungen/termine/seite-1/suche-none"

    GEOCODE_REGION = "97944 Boxberg"
    ...
    def _parse_german_date(self, date_str: str) -> Optional[date_class]:
        """Parst deutsches Datum: '22.03.2026' -> date(2026, 3, 22)"""
    ...
    def _parse_time(self, time_str: str) -> Optional[time_class]:
        """Parst Uhrzeit: '06:30 Uhr bis 10:30 Uhr' -> time(6, 30)"""
    ...
    def _parse_end_time(self, time_str: str) -> Optional[time_class]:
        """Parst Endzeit: '06:30 Uhr bis 10:30 Uhr' -> time(10, 30)"""
    ...
    def _parse_single_event(self, container: Tag) -> Optional[ScrapedEvent]:
        ...
        # External ID aus Container-ID: hwveranstaltung__record__497 -> 497
        ...
        external_id = f"boxberg_{event_id}_{event_date}"

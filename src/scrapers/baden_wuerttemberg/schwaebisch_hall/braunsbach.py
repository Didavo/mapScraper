"""
Scraper für die Gemeinde Braunsbach.
Website: https://www.braunsbach.de/freizeit-tourismus/veranstaltungskalender

HTML-basierter Scraper mit Pagination.
URL-Muster: /seite-{n}/suche-none
Events enthalten Datum, Uhrzeit, Location, Veranstalter und OSM-Koordinaten.
"""
...
class BraunsbachScraper(BaseScraper):
    """Scraper für Braunsbach Veranstaltungen."""

    SOURCE_NAME = "Gemeinde Braunsbach"
    BASE_URL = "https://www.braunsbach.de"
    EVENTS_URL = "https://www.braunsbach.de/freizeit-tourismus/veranstaltungskalender/seite-1/suche-none"

    GEOCODE_REGION = "74542 Braunsbach"
    ...
    def _parse_german_date(self, date_str: str) -> Optional[date_class]:
        """Parst deutsches Datum: '11.02.2026' -> date(2026, 2, 11)"""
    ...
    def _extract_address_from_maps_link(self, container: Tag) -> dict:
        ...
        # Format: ?q=Gemeinderatssitzung,Geislinger Str.9,74542Brausnbach
    ...
    def _get_total_pages(self, soup: BeautifulSoup) -> int:
        ...
        # "Letzte Seite" Link hat das höchste seite-N
        max_page = 1
    ...
    def _build_page_url(self, page: int) -> str:
        ...
        return f"{self.BASE_URL}/freizeit-tourismus/veranstaltungskalender/seite-{page}/suche-none"
    ...
    def _parse_single_event(self, container: Tag) -> Optional[ScrapedEvent]:
        ...
        # External ID aus Container-ID: hwveranstaltung__record__435 -> 435
        ...
        external_id = f"braunsbach_{event_id}_{event_date}"

"""
Scraper für die Gemeinde Blaufelden.
Website: https://www.blaufelden.de/freizeit/veranstaltungskalender
...
class BlaufeldenScraper(BaseScraper):
    """Scraper für Blaufelden Veranstaltungen."""

    SOURCE_NAME = "Gemeinde Blaufelden"
    BASE_URL = "https://www.blaufelden.de"
    EVENTS_URL = "https://www.blaufelden.de/freizeit/veranstaltungskalender/seite-1/suche-none"

    GEOCODE_REGION = "74572 Blaufelden"
    ...
    def _parse_german_date(self, date_str: str) -> Optional[date_class]:
        """Parst deutsches Datum: '14.02.2026' -> date(2026, 2, 14)"""
    ...
    def _build_page_url(self, page: int) -> str:
        ...
        return f"{self.BASE_URL}/freizeit/veranstaltungskalender/seite-{page}/suche-none"
    ...
    def _parse_single_event(self, container: Tag) -> Optional[ScrapedEvent]:
        ...
        # External ID aus Container-ID: hwveranstaltung__record__2471 -> 2471
        ...
        external_id = f"blaufelden_{event_id}_{event_date}"
